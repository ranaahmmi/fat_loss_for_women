            ...
            Consumer(builder: (context, watch, child) {
              ...
              return LinearPercentIndicator(
                ...
                center: Hero(
                  ...
                  child: Text((planProgress.planProgress)!.toStringAsFixed(1) +
                          " %  Completed")
                      .text
                      .bold
                      .white
              ...
              child: RoundCircle(
                ...
                () {
                  context.nextPage(PlanExerciseList(
                      dayID: 1, weekID: weekID, planID: planID));
                },
              ),
            ),
            Positioned(
              ...
              child: RoundCircle(
                ...
                () {
                  context.nextPage(PlanExerciseList(
                      dayID: 2, weekID: weekID, planID: planID));
                },
              ),
            ),
            Positioned(
              ...
              child: RoundCircle(
                ...
                () {
                  context.nextPage(PlanExerciseList(
                      dayID: 3, weekID: weekID, planID: planID));
                },
              ),
            ),
            Positioned(
              ...
              child: RoundCircle(
                ...
                () {
                  context.nextPage(PlanExerciseList(
                      dayID: 4, weekID: weekID, planID: planID));
                },
              ),
            ),
            Positioned(
              ...
              child: RoundCircle(
                ...
                () {
                  context.nextPage(PlanExerciseList(
                      dayID: 5, weekID: weekID, planID: planID));
                },
              ),
            ),
            Positioned(
              ...
              child: RoundCircle(
                ...
                () {
                  context.nextPage(PlanExerciseList(
                      dayID: 6, weekID: weekID, planID: planID));
                },
              ),
            ),
            Positioned(
    ...
    return DottedBorder(
      ...
      child: Container(
        ...
        child: isRestDay
            ...
            : title.text.bold.xl
                .color(
                    active ? AppColors.TextColorLight : AppColors.primaryColor)
                .makeCentered(),
      ),
    );
  }
